...
import 'package:pharmadigit/Client_panel/ForgotPasswordScreen/bloc/ForgotPass_state.dart';
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (val) {
                            BlocProvider.of<ForgotPasswordBloc>(context)
                                .add(ForgotPasswordTextChangedEvent(
                          ...
                          return InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: (state is ForgotPasswordValidState)
                                    ? Color(0xff249CB7)
                                    : Colors.grey,
                              ),
