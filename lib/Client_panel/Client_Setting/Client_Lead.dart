...
class ClientLead extends StatefulWidget {
  const ClientLead({super.key});

  @override
  State<ClientLead> createState() => _ClientLeadState();
}

class _ClientLeadState extends State<ClientLead> {
  var w;
  var h;
                    ...
                    Padding(
                      padding: EdgeInsets.only(
                          left: (Responsive.isDesktop(context))
                              ...
                              : 0.005),
                      child: Text(
                        "Lead Scoring & Prioritization Method ",
                        style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w500,
                        ),
